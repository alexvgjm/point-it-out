import { create, update } from "../../src/main";
import { availableShapes, PointItOutShape } from "../../src/shapes/core";
...
describe('update()', ()=>{
    it('should call update of each created shape', ()=>{
        const s1 = create('square', {target: '.existing'})      // GIVEN
        const s2 = create('square', {target: '.existing'})
        const s3 = create('square', {target: '.existing'})
